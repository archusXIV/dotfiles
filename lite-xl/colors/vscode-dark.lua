...
style.syntax["normal"] = { common.color "#7b81a6" }
style.syntax["symbol"] = { common.color "#879BB0" }
...
style.syntax["number"] = { common.color "#9DB392" }
style.syntax["literal"] = { common.color "#8be9fd" }
style.syntax["string"] = { common.color "#E6A286" }
style.syntax["string2"] = { common.color "#D38A8A" }
