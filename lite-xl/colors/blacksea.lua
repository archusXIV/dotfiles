...
style.background3 = { common.color "#3D4058" }
...
style.syntax["symbol"] = { common.color "#565B78" }
style.syntax["comment"] = { common.color "#333858" }
...
style.syntax["literal"] = { common.color "#69B0BF" }
