...
style.background2        = { common.color "#2e3440" }      -- treeview, other tabs
style.background3        = { common.color "#596366" }      -- menus
style.text               = { common.color "#1d2021" }
style.caret              = { common.color "#1d2021" }
style.accent             = { common.color "#D8DEE9" }      -- Text in autocomplete and command, col(>80) in satusbar
style.dim                = { common.color "#888888" }      -- Text of nonactive tabs, prefix in log
style.divider            = { common.color "#151515" }
style.selection          = { common.color "#888888" }
style.line_number        = { common.color "#888888" }
style.line_number2       = { common.color "#3b3b3b" }      -- Number on line with caret
