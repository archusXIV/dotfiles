...
style.background = { common.color "#1a1b26" } -- 1a1b26
...
style.scrollbar_size = common.round(8 * SCALE)        -- scrollbar width

style.syntax["normal"] = { common.color "#9ABDF5" }
style.syntax["symbol"] = { common.color "#b4bde6" }
style.syntax["comment"] = { common.color "#414868" }
style.syntax["keyword"] = { common.color "#d28de6" }  -- local function end, if case
style.syntax["keyword2"] = { common.color "#ff9e64" } -- self, int float
style.syntax["number"] = { common.color "#9ece6a" }
style.syntax["literal"] = { common.color "#7dcfff" }
style.syntax["string"] = { common.color "#6586cc" }
style.syntax["string2"] = { common.color "#6d5782" }
style.syntax["string3"] = { common.color "#ff4499" }
style.syntax["operator"] = { common.color "#2ac3de"}  -- = + - / < >
style.syntax["function"] = { common.color "#bb9af7" }

-- PLUGINS
style.linter_warning = { common.color "#e0af68" }     -- linter
style.bracketmatch_color = { common.color "#e0af68" } -- bracketmatch
