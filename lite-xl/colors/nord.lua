...
style.background3        = { common.color "#434c5e" } -- menus
...
style.divider            = { common.color "#616e88" }
...
style.syntax["keyword"]  = { common.color "#88C0D0" }
style.syntax["keyword2"] = { common.color "#81A1C1" }
style.syntax["number"]   = { common.color "#B48EAD" }
style.syntax["literal"]  = { common.color "#D8DEE9" }
