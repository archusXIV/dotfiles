...
# Script name: install_arch_base version 1.1.2
# License: GPLv2
#
...
github_repo="https://raw.githubusercontent.com/archusXIV/dotfiles/refs/heads/main/"
...
EOZ
    ...
    cat > /etc/sysctl.d/99-zram-parameters.conf <<EOS
vm.swappiness = 180
