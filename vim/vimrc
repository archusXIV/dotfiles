...
" Snippets
let g:UltiSnipsExpandTrigger="<tab>" " Trigger to expand snippets
let g:UltiSnipsJumpForwardTrigger="<c-j>" " Jump to next placeholder
let g:UltiSnipsJumpBackwardTrigger="<c-k>" " Jump to previous placeholder
" let g:UltiSnipsSnippetDirectories=["UltiSnips", "~/.config/vim/snippets/sh_snippets"]
